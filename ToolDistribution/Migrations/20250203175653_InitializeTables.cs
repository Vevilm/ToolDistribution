        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StorageID = table.Column<int>(type: "smallint", nullable: false),
                    ArticleID = table.Column<string>(type: "nvarchar(20)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                       name: "FK_Tools_ArticleID",
                       column: x => x.ArticleID,
                       principalTable: "Articles",
                       principalColumn: "ID",
                       onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                       name: "FK_Tools_StorageID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                       name: "FK_ToolRequests_ToolID",
                       column: x => x.ToolID,
                       principalTable: "Tools",
                       principalColumn: "ID",
                       onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                       name: "FK_Tools_WorkerID",
                       column: x => x.WorkerID,
